(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tools-scale-scale-module"], {
    ...
    function TcZR(module, __webpack_exports__, __webpack_require__) {
      ...
      function ScaleComponent_mat_list_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      ScaleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 21,
        vars: 2,
        consts: [["id", "scale"], [1, "header"], [1, "sub-title"], [1, "content"], [1, "scale-form", 3, "formGroup", "ngSubmit"], [1, "input-scale"], ["matInput", "", "placeholder", "\u8BF7\u8F93\u5165\u6570\u503C", "formControlName", "number"], ["formControlName", "scale"], ["value", "2"], ["value", "8"], ["value", "10"], ["value", "16"], ["mat-button", "", "type", "submit"], ["role", "list", 4, "ngIf"], ["role", "list"], ["mat-subheader", ""], ["role", "listitem"], ["mat-list-icon", ""], ["mat-line", ""]],
        template: function ScaleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ScaleComponent_Template_form_ngSubmit_6_listener() {
              return ctx.onSubmit();
            });
