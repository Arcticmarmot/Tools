(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tools-qr-code-qr-code-module"], {
    /***/
    "0FX9":
    /*!********************************************!*\
    ...
    "fXgg":
    /*!*********************************************************!*\
      !*** ./src/app/tools/qr-code/qr-code-routing.module.ts ***!
      \*********************************************************/

    /*! exports provided: QrCodeRoutingModule */

    /***/
    function fXgg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QrCodeRoutingModule", function () {
      ...
      var _qr_code_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./qr-code.component */
      "nAoo");

      var routes = [{
        path: '',
        component: _qr_code_component__WEBPACK_IMPORTED_MODULE_2__["QrCodeComponent"]
      }];

      var QrCodeRoutingModule = function QrCodeRoutingModule() {
        _classCallCheck(this, QrCodeRoutingModule);
      };

      QrCodeRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: QrCodeRoutingModule
      });
      QrCodeRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function QrCodeRoutingModule_Factory(t) {
          return new (t || QrCodeRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](QrCodeRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](QrCodeRoutingModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
    ...
    function mPVK(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatSlider = /*#__PURE__*/function (_MatSliderMixinBase2) {
        ...
        function MatSlider(elementRef, _focusMonitor, _changeDetectorRef, _dir, tabIndex, _ngZone, _document, _animationMode) {
          ...
          _this5._invert = false;
          _this5._max = 100;
          _this5._min = 0;
          _this5._step = 1;
          _this5._thumbLabel = false;
          _this5._tickInterval = 0;
          _this5._value = null;
          _this5._vertical = false;
          /** Event emitted when the slider value has changed. */

          _this5.change = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
          /** Event emitted when the slider thumb moves. */

          _this5.input = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
          /**
          ...
          _this5.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
          /** onTouch function registered via registerOnTouch (ControlValueAccessor). */

          _this5.onTouched = function () {};
          ...
          _this5._tickIntervalPercent = 0;
          /** The dimensions of the slider. */

          _this5._sliderDimensions = null;

          _this5._controlValueAccessorChangeFn = function () {};
          /** Subscription to the Directionality change EventEmitter. */


          _this5._dirChangeSubscription = rxjs__WEBPACK_IMPORTED_MODULE_10__["Subscription"].EMPTY;
          /** Called when the user has put their pointer down on the slider. */

          _this5._pointerDown = function (event) {
            // Don't do anything if the slider is disabled or the
            // user is using anything other than the main mouse button.
            if (_this5.disabled || _this5._isSliding || !isTouchEvent(event) && event.button !== 0) {
              return;
            }

            _this5._ngZone.run(function () {
              var oldValue = _this5.value;
              var pointerPosition = getPointerPositionOnPage(event);
              _this5._isSliding = true;
              _this5._lastPointerEvent = event;
              event.preventDefault();

              _this5._focusHostElement();

              _this5._onMouseenter(); // Simulate mouseenter in case this is a mobile device.


              _this5._bindGlobalEvents(event);

              _this5._focusHostElement();

              _this5._updateValueFromPosition(pointerPosition);

              _this5._valueOnSlideStart = oldValue; // Emit a change and input event if the value changed.

              if (oldValue != _this5.value) {
                _this5._emitInputEvent();
              }
            });
          };
          /**
          ...
          _this5._pointerMove = function (event) {
            if (_this5._isSliding) {
              // Prevent the slide from selecting anything else.
              event.preventDefault();
              var oldValue = _this5.value;
              _this5._lastPointerEvent = event;

              _this5._updateValueFromPosition(getPointerPositionOnPage(event)); // Native range elements always emit `input` events when the value changed while sliding.
          ...
          _this5._pointerUp = function (event) {
            if (_this5._isSliding) {
              event.preventDefault();

              _this5._removeGlobalEvents();

              _this5._isSliding = false;

              if (_this5._valueOnSlideStart != _this5.value && !_this5.disabled) {
                _this5._emitChangeEvent();
              }

              _this5._valueOnSlideStart = _this5._lastPointerEvent = null;
            }
          };
          /** Called when the window has lost focus. */


          _this5._windowBlur = function () {
            // If the window is blurred while dragging we need to stop dragging because the
            // browser won't dispatch the `mouseup` and `touchend` events anymore.
            if (_this5._lastPointerEvent) {
              _this5._pointerUp(_this5._lastPointerEvent);
            }
          };
          ...
          _ngZone.runOutsideAngular(function () {
            ...
            element.addEventListener('mousedown', _this5._pointerDown, activeEventOptions);
            element.addEventListener('touchstart', _this5._pointerDown, activeEventOptions);
          });
        ...
        _createClass(MatSlider, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this._focusMonitor.monitor(this._elementRef, true).subscribe(function (origin) {
              _this6._isActive = !!origin && origin !== 'keyboard';
    ...
    "nAoo":
    /*!****************************************************!*\
      !*** ./src/app/tools/qr-code/qr-code.component.ts ***!
      \****************************************************/

    /*! exports provided: QrCodeComponent */

    /***/
    function nAoo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _templates_title_title_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      QrCodeComponent.ɵfac = function QrCodeComponent_Factory(t) {
        return new (t || QrCodeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
      };
      ...
      QrCodeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 23,
        vars: 5,
        consts: [["id", "qr-code"], [1, "wrap"], [3, "title"], [1, "content"], [3, "formGroup", "ngSubmit"], [1, "data"], ["matInput", "", "formControlName", "data", "placeholder", "\u8BF7\u8F93\u5165\u5185\u5BB9"], [1, "width-slider"], ["formControlName", "width", "max", "1000", "min", "10", "thumbLabel", "", "tickInterval", "1"], [1, "color-wrap"], [1, "color"], ["type", "color", "matInput", "", "value", "#000000", "formControlName", "darkColor"], ["type", "color", "matInput", "", "value", "#FFFFFF", "formControlName", "lightColor"], ["mat-button", ""], ["scale", "100", "version", "3", 3, "qrdata", "width", "errorCorrectionLevel"]],
        template: function QrCodeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function QrCodeComponent_Template_form_ngSubmit_4_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "\u5BBD\u5EA6");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](10, "mat-slider", 8);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, "\u6DF1\u8272");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, "\u6D45\u8272");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](21, "\u751F\u6210");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](22, "qrcode", 14);
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("title", "\u4E8C\u7EF4\u7801\u751F\u6210");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("qrdata", "aa")("width", 100)("errorCorrectionLevel", "M");
          }
        },
        directives: [_templates_title_title_component__WEBPACK_IMPORTED_MODULE_2__["TitleComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_3__["MatFormField"], _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInput"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_3__["MatLabel"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_5__["MatSlider"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButton"], angularx_qrcode__WEBPACK_IMPORTED_MODULE_7__["QRCodeComponent"]],
        styles: ["#qr-code[_ngcontent-%COMP%] {\n  width: 100%;\n  height: auto;\n  display: flex;\n  justify-content: center;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%] {\n  width: 80%;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 900px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%] {\n  width: 40%;\n  height: 400px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   .data[_ngcontent-%COMP%] {\n  width: 80%;\n  font-size: 18px;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   .color-wrap[_ngcontent-%COMP%] {\n  width: 80%;\n  display: flex;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   .color-wrap[_ngcontent-%COMP%]   .color[_ngcontent-%COMP%] {\n  width: 50px;\n  height: 100px;\n  font-size: 18px;\n  margin-right: 80px;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   .width-slider[_ngcontent-%COMP%] {\n  width: 80%;\n  font-size: 18px;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   .width-slider[_ngcontent-%COMP%]   mat-slider[_ngcontent-%COMP%] {\n  width: 100%;\n}\n#qr-code[_ngcontent-%COMP%]   .wrap[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  width: 80%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/
    ...
    "uAJp":
    /*!*************************************************!*\
      !*** ./src/app/tools/qr-code/qr-code.module.ts ***!
      \*************************************************/
    ...
    function uAJp(module, __webpack_exports__, __webpack_require__) {
      ...
      var _qr_code_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./qr-code-routing.module */
      "fXgg");
      /* harmony import */


      var _qr_code_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./qr-code.component */
      "nAoo");
      /* harmony import */


      var _templates_title_title_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      QrCodeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _qr_code_routing_module__WEBPACK_IMPORTED_MODULE_2__["QrCodeRoutingModule"], _templates_title_title_module__WEBPACK_IMPORTED_MODULE_4__["TitleModule"], angularx_qrcode__WEBPACK_IMPORTED_MODULE_5__["QRCodeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_9__["MatSliderModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](QrCodeModule, {
          declarations: [_qr_code_component__WEBPACK_IMPORTED_MODULE_3__["QrCodeComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _qr_code_routing_module__WEBPACK_IMPORTED_MODULE_2__["QrCodeRoutingModule"], _templates_title_title_module__WEBPACK_IMPORTED_MODULE_4__["TitleModule"], angularx_qrcode__WEBPACK_IMPORTED_MODULE_5__["QRCodeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_9__["MatSliderModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_10__["MatButtonModule"]]
        });
      })();
      /*@__PURE__*/
...
//# sourceMappingURL=tools-qr-code-qr-code-module-es5.js.map