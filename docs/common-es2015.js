...
/* harmony import */ var _title_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./title.component */ "l2pl");
...
TitleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TitleComponent, selectors: [["app-title"]], inputs: { title: "title" }, decls: 4, vars: 1, consts: [[1, "header"], [1, "sub-title"]], template: function TitleComponent_Template(rf, ctx) { if (rf & 1) {
